...
public class LTCDashBoardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.lth_fragment, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mMainAdapter.addFragment(new LTCChartFragment(), "1H");
        mMainAdapter.addFragment(new LTCChartFragment(), "1D");
        mMainAdapter.addFragment(new LTCChartFragment(), "1W");
        mMainAdapter.addFragment(new LTCChartFragment(), "1M");
        mMainAdapter.addFragment(new LTCChartFragment(), "1Y");
        mMainAdapter.addFragment(new LTCChartFragment(), "ALL");
